...
export const updateContactAPI = (id, data) => apiHttp("PATCH", `/v1/client/contact/${id}`, data);
...
export const getContactByAliasAPI = (alias) => apiHttp("GET", `/v1/client/contact?alias=${alias}`);